 ...
 * Mengelola state loading, success, dan error untuk pengambilan data cuaca lokasi terkini.
 */
class DashboardViewModel(private val repository: WeatherRepository) : ViewModel() {
    ...
    /**
     * Memanggil API cuaca berdasarkan lat/lon menggunakan repository.
     */
    fun fetchWeather(lat: Double, lon: Double) {
        viewModelScope.launch {
            ...
            try {
                ...
                e.printStackTrace()
                _errorMessage.value = "Gagal memuat data cuaca. Silakan periksa koneksi internet Anda."
...
/**
 * Factory untuk DashboardViewModel agar dapat menyuntikkan WeatherRepository.
 */
